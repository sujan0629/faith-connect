...
export default function SetPasswordScreen() {
  ...
  const handleSetPassword = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        Toast.show({ type: 'success', text1: 'Account created!', text2: 'Welcome to FaithConnect.' });
    ...
    <SafeAreaView className="flex-1 bg-white">
      <View className="px-4 mt-2 py-3 border-b border-gray-200">
        <View className="flex-row items-center mt-2 mb-2 justify-between">
          <Pressable onPress={() => router.back()} className="w-10" disabled={isSubmitting}>
      ...
      >
        ...
        >
          <View className="flex-1">
            <Text className="text-dark text-xl font-bold text-center mb-3">Create your password</Text>
            <Text className="text-textSecondary text-xs text-center mb-2">Set a secure password for</Text>
            ...
            />
            <Text className="text-gray-500 mt-4 text-xs mb-8">
